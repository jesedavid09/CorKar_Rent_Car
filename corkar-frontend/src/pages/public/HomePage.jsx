    ...
    return (
        <div className="flex flex-col">
            ...
            <section className="bg-gray-50 py-20">
                <div className="max-w-7xl mx-auto px-6">
                    <div className="text-center mb-12">
                        ...
                        <p className="text-gray-500 mt-3">Reserva tu vehículo en 4 simples pasos</p>
                    </div>
            ...
            <section className="bg-white py-20">
                <div className="max-w-7xl mx-auto px-6">
                    <div className="text-center mb-12">
                        <h2 className="text-3xl font-bold text-gray-900">¿Por qué elegir CorKar?</h2>
                        <p className="text-gray-500 mt-3">Tu tranquilidad es nuestra prioridad</p>
                    </div>
                        ...
                        {[
                            {
                                ...
                                review: 'Excelente servicio. El vehículo estaba en perfectas condiciones y el proceso de reserva fue muy sencillo.',
                            },
                            {
                                name: 'Carlos Martínez',
                                location: 'Santiago',
                                review: 'Muy buena experiencia. Los precios son los mejores del mercado y la atención al cliente es de primera.',
                            },
                            {
                                name: 'Ana Rodríguez',
                                location: 'La Romana',
                                review: 'Rápido, fácil y confiable. Ya es la tercera vez que rento con CorKar y siempre quedo satisfecha.',
                            },
                        ].map((item) => (
                            <div key={item.name} className="bg-white p-6 rounded-2xl border border-gray-200 shadow-sm flex flex-col gap-4">
                                <div className="flex gap-1">
                                    {[...Array(5)].map((_, i) => (
                                        <Star key={i} size={16} className="text-yellow-400 fill-yellow-400" />
                                    ))}
                                </div>
                                <p className="text-sm text-gray-600 leading-relaxed italic">"{item.review}"</p>
